                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex space-x-2">
                                            ...
                                            <button onclick="toggleUserStatus(<?= $user['id'] ?>)" class="text-gray-600 hover:text-gray-800">
                    ...
                    <?php foreach ($departments as $department): ?>
                        <div class="border rounded-lg p-4">
                            <div class="flex justify-between items-start mb-2">
                                ...
                                <div class="flex space-x-2">
                                    <button onclick="editDepartment(<?= $department['id'] ?>)" class="text-blue-600 hover:text-blue-800">
                                        <i class="fas fa-edit"></i>
                                    </button>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        ...
                        <div class="border rounded-lg p-4">
                            ...
                            <p class="text-sm text-gray-600">Tamanho: 15.2 MB</p>
                        </div>
